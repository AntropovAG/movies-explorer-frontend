...
function Login({ onLogin, message, onMessageReset }) {
  ...
  return (
    <form className="login-form" name="login" onSubmit={handleSubmit} noValidate>
      ...
      <span className="login-form__input-error email-input-error">{emailError}</span>
      ...
      <button className="login-form__authorize-button" type="submit" disabled={(isValidEmail===false  || isValidPassword===false)}>Войти</button>
